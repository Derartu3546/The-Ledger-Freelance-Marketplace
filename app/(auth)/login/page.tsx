...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(next ?? (data.user.role === "CLIENT" ? "/dashboard/client" : "/dashboard/freelancer"));
    } catch (err: any) {
  ...
  return (
    <div className="max-w-md mx-auto py-16 px-4 relative ">
      ...
      <h1 className="font-display text-3xl font-bold mb-2 fade-in-up">Welcome back</h1>
